...
$hloops = $total-1;
foreach ((array) $multiple_hotspots as $hkey => $hvalue) {
...
foreach ((array) $scene_one_params as $sonekey => $sonevalue) {
...
foreach ((array) $scene_one_hotspots as $honekey => $honevalue) {
...
foreach ((array) $scene_two_params as $stwokey => $stwovalue) {
...
foreach ((array) $scene_two_hotspots as $htwokey => $htwovalue) {
...
foreach ((array) $scene_three_params as $sthreekey => $sthreevalue) {
...
foreach ((array) $scene_three_hotspots as $hthreekey => $hthreevalue) {
...
foreach ((array) $scene_four_params as $sfourkey => $sfourvalue) {
...
foreach ((array) $scene_four_hotspots as $hfourkey => $hfourvalue) {
...
foreach ((array) $scene_five_params as $sfivekey => $sfivevalue) {
...
foreach ((array) $scene_five_hotspots as $hfivekey => $hfivevalue) {
...
foreach ((array) $scene_six_params as $ssixkey => $ssixvalue) {
...
foreach ((array) $scene_six_hotspots as $hsixkey => $hsixvalue) {
...
foreach ((array) $scene_seven_params as $ssevenkey => $ssevenvalue) {
...
foreach ((array) $scene_seven_hotspots as $hsevenkey => $hsevenvalue) {
