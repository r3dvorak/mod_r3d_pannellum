...
foreach ($scene_one_params as $sonekey => $sonevalue) {
        ...
        $scene_one_hfov[]               = $sonevalue->scene_one_hfov;
        $scene_one_yaw[]                = $sonevalue->targetyaw;
        $scene_one_pitch[]              = $sonevalue->scene_one_pitch;
...
foreach ($scene_two_params as $stwokey => $stwovalue) {
        ...
        $scene_two_hfov[]               = $stwovalue->scene_two_hfov;
        $scene_two_yaw[]                = $stwovalue->targetyaw;
        $scene_two_pitch[]              = $stwovalue->scene_two_pitch;
...
foreach ($scene_three_params as $sthreekey => $sthreevalue) {
        ...
        $scene_three_hfov[]               = $sthreevalue->scene_three_hfov;
        $scene_three_yaw[]                = $sthreevalue->targetyaw;
        $scene_three_pitch[]              = $sthreevalue->scene_three_pitch;
...
foreach ($scene_four_params as $sfourkey => $sfourvalue) {
        ...
        $scene_four_hfov[]               = $sfourvalue->scene_four_hfov;
        $scene_four_yaw[]                = $sfourvalue->targetyaw;
        $scene_four_pitch[]              = $sfourvalue->scene_four_pitch;
...
foreach ($scene_five_params as $sfivekey => $sfivevalue) {
        ...
        $scene_five_hfov[]               = $sfivevalue->scene_five_hfov;
        $scene_five_yaw[]                = $sfivevalue->targetyaw;
        $scene_five_pitch[]              = $sfivevalue->scene_five_pitch;
...
foreach ($scene_six_params as $ssixkey => $ssixvalue) {
        ...
        $scene_six_hfov[]               = $ssixvalue->scene_six_hfov;
        $scene_six_yaw[]                = $ssixvalue->targetyaw;
        $scene_six_pitch[]              = $ssixvalue->scene_six_pitch;
...
foreach ($scene_seven_params as $ssevenkey => $ssevenvalue) {
        ...
        $scene_seven_hfov[]               = $ssevenvalue->scene_seven_hfov;
        $scene_seven_yaw[]                = $ssevenvalue->targetyaw;
        $scene_seven_pitch[]              = $ssevenvalue->scene_seven_pitch;
